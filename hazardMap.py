class hazardMap:
    ...
    def __init__(self, zip_code):
        ...
        self.root_path = '/home/nathan/Insight/Tree Data/'
        self.root_image_path = self.root_path + 'SAS Output/'
        self.generate_image_path = '/home/nathan/Insight/Code/generateImages.ipynb'
        address_info_path = self.root_path + 'LA_County_Parcels_small.csv'
        footprint_info_path = self.root_path + 'Building_Footprints-shp/footprint_nodes.csv'
        parcel_info_path = self.root_path + 'parcel_locations.csv'
    ...
    def map_by_address(self, image, thresh, class_label=5, imsize=1024):
        ...
        imsize: side length of image in pixels
        """
        label_image = self.remove_small_clusters(image, thresh, class_label, class_pick=True)
    ...
    def get_tree_bounds(self, image, conf_thresh=0.3, overlap_thresh=10, imsize=1024, display=False):
        ...
        # Load Yolo
        net = cv2.dnn.readNet(self.root_path + "yolov3_training_final.weights",
                              self.root_path + "yolov3_testing.cfg")
